...
#/Applications/Adobe\ Flash\ Builder\ 4.7/eclipse/plugins/com.adobe.flash.compiler_4.7.0.349722/AIRSDK/bin/adt -package -target ane weibo.ane extension.xml -swc weibo_ios.swc -platform default library.swf -platform iPhone-ARM  libWeiboAPI.a library.swf
